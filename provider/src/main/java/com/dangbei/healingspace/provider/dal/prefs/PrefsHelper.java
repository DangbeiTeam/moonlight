package com.dangbei.healingspace.provider.dal.prefs;
...
public class PrefsHelper {
    ...
    @SuppressLint("CommitPrefEdits")
    public PrefsHelper(String name, int mode, Context context) {
    ...
    public PrefsHelper() {
        if (null == prefs) {
            prefs = ProviderApplication.getInstance().getApplication()
                    .getSharedPreferences("screen_saver", getModeCompat());
        }
        editor = prefs.edit();
    }
    ...
    public static class Holder {
        ...
        static PrefsHelper INSTANCE = new PrefsHelper();
    }

    public static PrefsHelper getInstance() {
        return PrefsHelper.Holder.INSTANCE;
    }
